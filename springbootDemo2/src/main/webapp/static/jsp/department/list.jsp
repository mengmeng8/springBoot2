...
<body>
	...
	<s:iterator value="list" var="d">
		<tr>
			...
			<td align="center"><a href="${pageContext.request.contextPath}/department_delete.action?did=<s:property value="#d.did"/>"><img src="${pageContext.request.contextPath}/images/del.jpg"/></a></td>
		</tr>
	  </s:iterator>
		</tbody>
	</table>
